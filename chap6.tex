...
\begin{lem}
  ...
  \begin{align}
    ...
    \Big( \frac{1}{r^{d -1 }}\int_{D_\eta(r)} |u|^{p_d} \d x \Big)^{1/p_d} \leq C \, \Big( \frac{1}{r^{d - 1}} \int_{D_\eta(2r)} |u|^2 \d x \Big)^{1/2},
  \end{align}
...
The following Lemma, which appeared in Tolskdorf \cite[Lem. 4.2]{tolksdorf2017}, reduces the amount of work that needs to be done to a few special cases.
...
\begin{lem}
 ...
 % Then for all balls $\BB(x_0, r)$ that are either centered on $\partial\Omega$ or satisfy $\alpha_2 \BB(x_0, r) \subseteq \Omega$ the estimate
  \begin{align}
    ...
    \Big( \frac{1}{r^{d - 1}} \int_{\BB(x_0, r) \cap \Omega} |u|^p \Big)^{1/p} \leq C \, \Big( \frac{1}{r^{d - 1}} \int_{\BB(x_0, 2 r) \cap \Omega} |u|^2 \Big)^{1/2}
  \end{align}
  holds, where $p = p_d$.
...
\begin{proof}
  ...
  Let $x_0 \in \Omega$ with $\alpha_2 \BB(x_0,r) \subseteq \Omega$. We may deploy the interior estimate \eqref{eq:interiorEstimateDoubleLayer} to derive that for all $x \in \BB(x_0,r)$ the estimate
  \begin{align*}
    |u(x)|^p \leq C \Big( \frac{1}{r^{d - 1}} \int_{\BB(x,r)} |u(y)|^2 \d y \Big)^{p/2}
  \end{align*}
  holds which after integrating $x$ over $\BB(x_0, r)$ yields
  \begin{align*}
    \frac{1}{r^{d - 1}}\int_{\BB(x_0, r)} |u(x)|^p \d x \leq C \Big(\alpha_1^d  \frac{1}{r^{d-1}}\int_{\BB(x_0, \alpha_1 r)} |u(z)|^2 \d z \Big)^{p/2},
  \end{align*}
...
\begin{proof}[Proof of Theorem \ref{thm:main}]
  ...
  We already know that $u = (1 + |\lambda|)^{-1} T_\lambda(f) = (A_2 + \lambda)^{-1} \PP_2(f) \in \Ell^p_\sigma(\Omega) \cap \Dom(A_2)$  by the mapping properties of $T_\lambda(f)$. As $\Ell^q_\sigma(\Omega) \subseteq \Ell^2_\sigma(\Omega)$ we have furthermore that
  \begin{align*}
