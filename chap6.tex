...
\begin{proof}
  ...
  \begin{align*}
    ...
    &\leq \bigg( \frac{1}{r^d} \int_{D_{\eta_{x_0}}(r)} |u|^p \bigg)^{1/p} \\
    &\leq C \, \bigg( \frac{1}{r^d} \int_{D_{\eta_{x_0}}(2 r)} |u|^p \bigg)^{1/p} \\
...
\end{proof}
  ...
  \begin{prop}[Giaquinta, Modica]
    ...
    \end{align*}
    for all $x_0 \in \Omega$ and $0 < r < \min\big\{ R_0, \operatorname{dist}(x_0, \partial\Omega)/2\big\}$.
    Then $f \in \Ell^{q + \varepsilon}_{\mathrm{loc}}(\Omega)$ for some $\varepsilon > 0$, depending only on $d$, $q$, and $b$ and there is a constant $\tilde C$ depending only on $d$, $q$, $\varepsilon$ and $b$ such that
    \begin{align*}
  ...
  \begin{rem}
    ...
    \begin{align*}
      ...
      &= \bigg( \frac{1}{r^d} \int_{\BB(x_0, r) \cap \Omega} |u|^p \d x \bigg)^{2/p} \\
    ...
    \begin{align*}
      ...
      &= \bigg( \frac{1}{r^d} \int_{\BB(x_0, r/2)} f^{q + \varepsilon} \d x \bigg)^{1/(q + \varepsilon)} \\
      &\leq \tilde C \bigg( \frac{1}{r^d} \int_{\BB(x_0, r) \cap \Omega} |u|^p \d x \bigg)^{1/p} \\
...
We are now in the position to prove Theorem \ref{thm:main}, the main theorem of this thesis. For this, the improved weak reverse H\"older inequality derived in Remark \ref{rem:reverseHoelder} will serve as the crucial ingredient, enabling us to apply the extrapolation theorem \ref{thm:extrapolation} to a suitable family of operators.
...
\begin{proof}[Proof of Theorem \ref{thm:main}]
  ...
  Furthermore, by testing this identity with $u$ and then using the Poincar\'e inequality together with Lemma~\ref{lem:laxMilgramIneq}, we derive the estimate
  \begin{align*}
  ...
  We already know that $u = (1 + |\lambda|)^{-1} T_\lambda(f) = (A_2 + \lambda)^{-1} \PP_2(f) \in \Ell^q_\sigma(\Omega) \cap \Dom(A_2)$  by the mapping properties of $T_\lambda(f)$. As $\Ell^q_\sigma(\Omega) \subseteq \Ell^2_\sigma(\Omega)$ we have furthermore that
  \begin{align*}
