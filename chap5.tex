...
In the following remark and the forthcoming chapter we will make use of an integration argument which can be considered as an application of the following Theorem on \emph{integration along slices}. A proof of this result can be found in Federer \ref[Thm. 3.2.12]{federer}.
