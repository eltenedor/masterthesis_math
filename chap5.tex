...
\begin{proof}
  ...
  Finally let $d = 2$.
  Then for $\nu = (d/2) - 1 = 0$ and $z = k|x|$ as in Chapter \ref{chap:2}, Lebedev \cite[Sec. 5.11]{lebedev} gives that
  \begin{align*}
...
\begin{proof}
  ...
  With the above definitions at hand, Lemma \ref{lem:inverseEstimate} states that $K_{X,Y}$ is an invertible operator on $Y$ with operator norm of the inverse bounded by $C$, depending at most on $d$, $\theta$ and the Lipschitz character of $\Omega$.
