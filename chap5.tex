...
\begin{proof}
  ...
  \begin{align*}
      ...
      &\quad\leq C \sqrt{|\lambda|} \int_{\partial\Omega} \frac{1}{|p - y|^{d - 2}} \d \sigma(y) \\[0.5em]
      &\quad= C \sqrt{|\lambda|}\, \int_{\partial\Omega \cap \BB(p, r_0/4)} \frac{1}{|p - y|^{d - 2}} \d\sigma(y) + C \sqrt{|\lambda|}\, \int_{\partial\Omega \setminus \BB(p, r_0/4)} \frac{1}{|p - y|^{d - 2}} \d\sigma(y) \\[0.5em]
  ...
  \begin{align*}
      &\|\nabla u_+ \|_\partial + \Big\| \phi_+ - \frac{1}{r_0^{d - 1}}\int_{\partial\Omega} \phi_+ \d\sigma \Big\| \\[0.5em]
      &\qquad\leq C\, \Big\{ \|( \nabla_{\mathrm{tan}} u)_+ \|_\partial + |\lambda|^{1/2} \|u_+\|_\partial + |\lambda| \| u_+\cdot n\|_{\HH^{-1}(\partial\Omega)} \Big\} \\[0.5em]
  ...
  \begin{align*}
      ...
      &\leq \Big\|\bigg(\frac{\partial u}{\partial n} \bigg)_+ \Big\|^{}_\partial + C\, \| \phi_+ \|_\partial \\
