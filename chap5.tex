...
\begin{proof}
 ...
 Furthermore, we have $|\nabla u(x)| = O(|x|^{1 - d})$ by estimate \ref{eq:fundamentalMatrixEstimate}.
  ...
  If $d = 2$, then the asymptotic behavior of the fundamental solution to the scalar Helmholtz equation is already available. Through dominated convergence the same asymptotic behavior holds for $u(x)$.
\end{proof}
