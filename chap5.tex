...
\begin{rem}
  Let $(u,\phi)$ be a solution of the Stokes resolvent system in the domain $\BB(x_0, r)$.
  \begin{align}
  ...
  For $t \in (1,2)$ we now apply Theorem \ref{thm:exAndUniqueSolution} in the domain $\BB(0, t)$ to derive the estimate
  \begin{align*}
    |\nabla^l u(x_0)|^2 \leq C_l \int_{\partial \BB(0, t)} |u|^2(y) \d\sigma(y).
  \end{align*}
