...
\begin{rem}
  ...
  \begin{align}
    ...
    |\nabla^l u(x_0) | \leq \frac{C_l}{r^{d - 1 + l}} \Big( \int_{\BB(x_0, r)} |u(x)|^2 \d x \Big)^{1/2}
  \end{align}
  ...
  \begin{align*}
    |\nabla^l u(0)|^2 
    &\leq C\, \Big( \int_{\partial \BB(0, t)} \Big\{ \big|\nabla_x^{l+1} \Gamma(y; \lambda)\big|  + \big|\nabla_x^l \Phi(y) \big| \Big\} |f_t(y)| \d\sigma(y)\Big)^2 \\
