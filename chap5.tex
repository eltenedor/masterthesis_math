...
\begin{proof}
  ...
  The proof of \eqref{weizhangestimate} was carried out by Wei and Zhang in \cite[Lem. 3.3]{weiZhang} and can also be found in Shen's paper \cite[p. 418f.]{Shen2012}.

  Up to this point we do not know wether the right hand side of this inequality equals infinity.
  We only know that $(u,\phi)$ solves the Stokes resolvent problem and it implicitly solves a Dirichlet problem with boundary data given as $f = \operatorname{Tr} u \in \Ell^2(\partial\Omega; C^d)$.
  ...
  Furthermore the trace theorem on bounded Lipschitz domains gives us for all $h \in \HH^0(\Omega; \C^d)$ that
  \begin{align}
