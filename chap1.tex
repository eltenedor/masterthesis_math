...
For $p > 2$ there exists an analog to Theorem \ref{thm:stokesOperatorL2}.
...
\begin{thm}[Tolksdorf]
  ...
  \begin{align*}
    \Dom(A_2) = \big\{ u \in \WW^{1,p}_{0,\sigma}(\Omega) \colon \exists \pi \in \Ell^p(\Omega) \text{ s.t. } -\Delta u + \nabla \pi \in \Ell^p_\sigma(\Omega) \big\},
  \end{align*}
...
One adequate way is to dualize the operator $A_{p'}$.
...
\begin{lem}
  ...
  \end{align*}
  the spaces $\Ell^p_\sigma(\Omega)$ and $(\Ell^{p'}_\sigma(\Omega))^*$ are isomorphic.
\end{lem}
