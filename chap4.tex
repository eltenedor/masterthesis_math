...
%    &\leq C \int_{\partial\Omega_j} |f(p)|^2 \d\sigma(p)
%  \end{align*}
%  this and similar calculation for the tangential derivatives of $\psi$ shows that we may bound $\|\psi\|_{\HH^1{\partial\Omega}}$ by $\|f\|_{\HH^1}$.
%  This shows that
%  \begin{align*}
...
After all this preparation we have acquainted enough tools and are now able to prove Theorem \ref{thm:rellich}.
