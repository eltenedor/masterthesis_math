...
\begin{proof}
  ...
  \end{align*}
  where for the last inequality we used further results for the regularity problem of the Dirichlet Laplacian, see \cite[Thm.\@~7.5.15]{Shen2017}. 
  Not that we assumed also that the cited result holds for bounded Lipschitz domains that do not have a connected boundary.
