...
\begin{lem}
  ...
  \begin{align}
    ...
    \| \nabla u\|_\partial \leq C_\varepsilon \,\bigg\| \frac{\partial u}{\partial \nu} \bigg\|_\partial + \varepsilon \Big\{ \|\nabla u\|_\partial + \|\phi\|_\partial + \| \, |\lambda|^{1/2} u\|_\partial \Big\}
  \end{align}
  and
  \begin{align}
...
\begin{proof}
  ...
  \begin{align}
    ...
    \begin{alignedat}{1}
    \|\nabla u\|_\partial^2
    &\leq C \, \bigg\{ \|\nabla u\|_\partial \, \bigg\| \frac{\partial u}{\partial \nu} \bigg\|_\partial + \int_\Omega |\nabla u|^2 \d x \\
...
To this end, for the third integral we calculate
  \begin{align}
    ...
    \leq C \, \bigg\| \frac{\partial u}{\partial \nu} \bigg\|_\partial^{1/2} \|u\|_\partial^{1/2} \, \|\phi\|_\partial\,, \label{eq:nablaPhi}
  \end{align}
  ...
  \begin{align}
    ...
    &\leq C \, \bigg\| \frac{\partial u}{\partial \nu} \bigg\|_\partial \big\|\, |\lambda|^{1/2} u\,\big\|_\partial, 
  \end{align}
  ...
  \begin{align*}
    ...
    + \bigg\| \frac{\partial u}{\partial \nu} \bigg\|_\partial^{1/2} \|u\|_\partial^{1/2} \|\phi\|_\partial 
    + \bigg\| \frac{\partial u}{\partial \nu} \bigg\|_\partial \big\| \, |\lambda|^{1/2} u\, \big\|_\partial\bigg\}
  \end{align*}
