...
\begin{proof}
  ...
  Let $f \in \HH^1(\partial\Omega_j)$ and let $\psi$ solve the regularity problem for the Laplacian on $\BB_R \setminus \overline{\Omega_j}$ with data $\tilde f$, where $\BB_R$ is a sufficiently large ball that contains $\overline\Omega$ and $\tilde f$ is defined via
  \begin{align*}
    ...
    \end{cases}
  \end{align*}
  With this definition at hand, we calculate using the divergence theorem
  \begin{align*}
