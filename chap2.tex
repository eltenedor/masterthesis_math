...
\begin{proof}
  ...
  \begin{align}
    ...
    \nabla_x^{} G(x; \lambda)
    &= C  \cdot \Big\{|x|^{1 - d} \cdot (k|x|)^{\frac{d}{2} - 1} H_{\frac{d}{2} - 1}^{(1)}(k|x|) - |x|^{2 - d} (k|x|)^{\frac{d}{2} - 1} H_{\frac{d}{2}}^{(1)}(k|x|) \cdot k\Big\} \nonumber\\[0.5em]
    &= C \cdot |x|^{1 - d}\Big\{(k|x|)^{\frac{d}{2} - 1} H_{\frac{d}{2} - 1}^{(1)}(k|x|) -  (k|x|)^{\frac{d}{2}} H_{\frac{d}{2}}^{(1)}(k|x|) \Big\},
  \end{align}
...
\begin{align*}
  -\ii\, \bigg( \frac{2}{\pi} \bigg)^{1/2} = \frac{2 \Gamma(1/2)}{\ii\pi}.
\end{align*}
...
%    \end{align*}
  ...
  \item Next, we consider thee case $d = 3$ and $l = 1$. 
    ...
    \begin{align*}
      \bigg| \frac{\partial}{\partial x_j} \bigg\{ \frac{\e^{\ii k |x|} - 1}{|x|} \Big\} \bigg|
...
\end{thm}
  ...
  \begin{proof}
    ...
    \begin{align*}
      ...
      &\leq\frac{C_l\, \e^{-c \sqrt{|\lambda|} |x|}}{|x|^{d - 2 + l}} + \frac{1}{|\lambda|} \frac{C_{l + 2}\, \e^{-c \sqrt{|\lambda|} |x|}}{|x|^2 |x|^{d - 2 + l}} + \frac{1}{|\lambda|} \frac{C}{|x|^2 |x|^{d - 2 + l}} \\[0.5em]
...
\end{align}
  ...
  \intertext{In the case $d = 2$, we use
    $$
  \frac{1}{8\pi} \frac{\partial^2}{\partial x_\alpha \partial x_\beta} (|x|^2 \log(|x|))
...
\begin{align*}
  ...
  &= \Big(\frac{\d{}}{\d z} g\Big)(k|x|) \cdot \frac{k x_\beta}{|x|}, \\[0.5em]
  %
...
\begin{align*}
  &\bigg|\frac{1}{\lambda} \nabla_x^3 \bigg\{ \frac{\ii}{4 (2\pi)^{\frac{d}{2} - 1}} \frac{1}{|x|^{d - 2}} \Big\{ z^{\frac{d}{2} - 1} H_{\frac{d}{2} - 1}^{(1)}(z) - a_d - b_d z^2\Big\} \bigg\} \bigg| \\[0.5em]
